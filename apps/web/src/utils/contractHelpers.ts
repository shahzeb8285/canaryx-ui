...
import tokenGenABI from 'config/abi/tokenGenABI.json';
...
export const getSouschefContract = (id: number, signer?: Signer | Provider) => {
  ...
  return getContract({ abi, address: getAddress(config.contractAddress,ChainId.SONGBIRD), signer }) as SousChef
}
...
export const getTokenGenContract = (signer?: Signer | Provider) => {
  return getContract({ abi: tokenGenABI, address: getTokenGenAddress(), signer }) as TokenGenABI
}
