...
import { bsc, bscTestnet, goerli, mainnet ,songbird} from 'wagmi/chains'
...
export const { provider, chains } = configureChains(CHAINS, [
  jsonRpcProvider({
    rpc: (chain) => {
      ...
      if (chain.id === songbird.id) {
        return { http: "https://sgbnode2.canaryx.finance/rpc" }
      }
...
//   options: {
//     showQrModal: true,
//     projectId:"44e2c62db046202261b5412a8b3849b3"
//   },
// })
